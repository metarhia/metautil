...
const timestamp = Buffer.allocUnsafe(TIMESTAMP_BYTES);

const encodeTimestamp48 = (msec, target) => {
  timestamp.writeUIntBE(msec, 0, TIMESTAMP_BYTES);
...
const decodeTimestamp48 = (encoded) => {
  ...
  return timestamp.readUIntBE(0, TIMESTAMP_BYTES);
};
...
module.exports = { generateId, encodeTimestamp48, decodeTimestamp48 };
