...
const unicodeCategories = require('./utils/unicode-categories');
...
class AuthenticationStrength {
  constructor(
    valid, // Boolean
    hints, // Object, { required: Array, optional: Array }
    compliance // Number, ratio of passed optional tests to all optional tests
  ) {
    this.valid = valid;
    this.hints = hints;
    if (!valid) {
